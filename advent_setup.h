...
static const verification_test tests[] =
{
	...
	DAY(thirteen,2545,266204454441577),
	TESTCASE(day_fourteen_testcase_a,165),
	TESTCASE(day_fourteen_testcase_b,208),
	DAY(fourteen,7440382076205,4200656704538),
	...
	DAY(twentythree,36542897,562136730660),
	...
	DAY(twentyfour,436,4133),
	TESTCASE(day_twentyfive_testcase_a, 14897079),
	DAY(twentyfive, 10187657,"MERRY CHRISTMAS!")
};
